...
const Footer = () => {
  return (
    <section className="pt-32 pb-9 px-12">
      <div className="container">
        <footer>
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
            <a
              href="/"
              className="text-3xl font-bold tracking-tighter text-blue-600 transition duration-500 ease-in-out lg:pr-8"
            >
              Medic Ai
            </a>
            <div className="flex flex-col gap-4 md:flex-row md:items-center">
              ...
              <div className="flex gap-2">
                <a href="#" className="inline-flex rounded-lg bg-zinc-900 p-2.5 justify-center items-center">
                
                <svg
                  stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 384 512"
                  className="size-7 text-background" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z">
                  </path>
                </svg></a>
                <a href="#" className="inline-flex rounded-lg bg-zinc-900 p-2.5 justify-center items-center">
                <img src="/logo192.png" className="size-6 text-background" alt="google play" /></a>
              </div>
            </div>
          </div>
          <div data-orientation="horizontal" role="none" className="shrink-0 bg-border h-[1px] w-full my-14"></div>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-4 text-zinc-600">
                <li className="font-medium hover:text-gray-800"><a href="#">Term of Services</a></li>
                <li className="font-medium hover:text-gray-800"><a href="#">Privacy Policy</a></li>
              </ul>
              ...
              <ul className="flex space-x-6 text-zinc-600 items-center">
                <li className="font-medium hover:text-gray-800">
                  <a href="#"><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 640 512"
                    className="size-6" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <li className="font-medium hover:text-gray-800">
                  <a href="#"><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512"
                    className="size-6" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <li className="font-medium hover:text-gray-800">
                  <a href="#"><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512"
                    className="size-6" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <path
          ...
          <div data-orientation="horizontal" role="none" className="shrink-0 bg-border h-[1px] w-full my-14"></div>
          <p className="text-sm text-zinc-600">© 2024 Wickedblocksblocks. All rights reserved.</p>
        </footer>
      </div>
    </section>
  );
